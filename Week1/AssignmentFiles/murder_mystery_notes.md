...
Could not find conclusive evidence so I checked the two suspect's interviews. Joe Germuska was not interviewed.
SELECT * 
  FROM interview
...
Checked the solution table and person_id 67318, Jeremy Bowers is the murderer. But based on his interview he was hired to murder.
