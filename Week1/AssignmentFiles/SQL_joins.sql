...
select order_items.order_id, orders.order_datetime, stores.name as store_name, 
...
stores.name as store_name, orders.order_datetime, 
...
-- but while looking at PARTITION BY I found the DENSE_RANK command and I figured IT out.
...
dense_rank() over (partition by stores.store_id 
...
CONCAT(employees.first_name, ' ', employees. last_name) as manager_name, employees.hire_date
from employees
